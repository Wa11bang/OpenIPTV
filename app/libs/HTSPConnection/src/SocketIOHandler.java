...
public class SocketIOHandler implements Connection.IOHandler {
    ...
    private final HTSPMessageHandler htspMessageHandler;

    SocketIOHandler(HTSPSerializer htspSerializer, HTSPMessageHandler htspMessageHandler)
    {
        this.htspSerializer = htspSerializer;
        this.htspMessageHandler = htspMessageHandler;
    }

    @Override
    public boolean hasWriteableData() {
        return htspMessageHandler.hasPendingMessages();
    }
    ...
    public boolean write(SocketChannel socketChannel) {
        ...
        HTSPMessage message = htspMessageHandler.getMessage();
    ...
    public boolean read(SocketChannel socketChannel) {
        ...
        while (bytesConsumed != 0 && bytesToBeConsumed > 0) {
            ...
            htspMessageHandler.onMessage(message);
